...
> Cập nhật lần cuối: 2026-09-10 — **✅ Specs 001–014 done (013 PR #14 + 014 PR #15 đã merge). 🟡 Spec 015 `downloads-manager` production code complete, 104/121. Phase 1 6/6 + Phase 2 6/6; Phase 3 3/3 production-ready → Phase 4 mở khoá.**
...
**Phase 3** (2/3 merged, 3/3 production-ready): 🟡 **Spec 015 `downloads-manager` production code complete** on branch `015-downloads-manager` (104/121; 12 manual device gates + T109/T110 behind gate G9 + PR remain). Spec 013 merged into `main` via PR #14; **✅ Spec 014 merged into `main` via PR #15** (2026-09-10, commit `2e7c633`; **111/113 tasks** — chỉ còn T103b, tức SC-005 perf p99 ≤ 16 ms cần **release build trên máy thật cỡ Pixel 5**, deferred và đã flag trong PR body). Còn lại của Phase 3: **Spec 015 `downloads-manager`**.

### Spec 015 — Downloads Manager (🟡 production code complete 2026-09-10, 104/121)
