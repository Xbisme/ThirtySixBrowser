...
> v1.0: Android Native Browser — ✅ Specs 001–015 done (013, 014, 015 đều đã merge vào `main`; 015 qua PR #16). **Phase 3 3/3** → Phase 4 (016–018) mở khoá; spec kế tiếp: **016 `settings-screen`**.
