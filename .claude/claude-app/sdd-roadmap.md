...
> v1.0: Android Native Browser — ✅ Specs 001–015 done (013, 014, 015 đều đã merge vào `main`; 015 qua PR #16). **Phase 3 3/3**. 🟢 **016 `settings-screen` đã implement** — PR #18 đang mở (112/113 — còn TalkBack pass của T109, cần người thật); sau đó là 017 `splash-screen`.
