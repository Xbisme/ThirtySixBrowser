...
> v1.0: Android Native Browser — ✅ Specs 001–015 done (013, 014, 015 đều đã merge vào `main`; 015 qua PR #16). **Phase 3 3/3**. 🟢 **016 `settings-screen` đã implement** trên branch `016-settings-screen` (111/113 — còn TalkBack pass của T109, cần người thật, và PR T113); sau đó là 017 `splash-screen`.
