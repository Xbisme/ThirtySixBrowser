...
> v1.0: Android Native Browser — ✅ Specs 001–016 done (013, 014, 015, 016 đều đã merge vào `main`; 016 qua PR #18, merge commit `3083941`, 2026-09-12). **Phase 3 3/3 · Phase 4 1/3 merged + 017 đã implement** (Spec 016 ở 112/113 — còn TalkBack pass của T109, cần người thật). ✅ **017 `splash-screen` merged 2026-09-15 — PR #20, merge commit `cca5c0c`, CI xanh 6/6, 35/35 tasks.** **Phase 4 giờ 3/3 — 🎉 v1.0 FEATURE-COMPLETE.** 🟢 **018 `onboarding-flow` implemented 2026-09-15 — 41/41 tasks, PR #24 đang mở.** Sau khi merge 018, Specs 001–018 đủ; còn lại là các mục nợ trước khi nộp store (số đo phần cứng Spec 014/015, screen-reader pass Spec 016/017/018).
...
| 018 | `onboarding-flow` | 4 slide: chào + cam kết riêng tư · ngôn ngữ · theme · search engine | Lần đầu mở → onboarding → main; Skip mọi slide; đổi ngôn ngữ vẫn giữ đúng slide | 003, 004, 006, 017 | 🟢 **Implemented 2026-09-15 — 41/41 tasks, PR #24 đang mở.** Không thêm dependency; Room vẫn v2. unit ✅ 579/579 (+22) · instrumented ✅ 109/109 trên AVD 16 KB · lint/detekt/ktlint ✅ · 16KB ✅ · APK **3,134,976 B** (+8,764 B, dùng 4,3% ngân sách) · **G1–G12 đều PASS**, gồm 4 gate blocking. ⚠️ Hai bẫy kỹ thuật: đọc cờ từ settings *flow* trong `setContent` sẽ đưa **mọi** lần mở vào onboarding (vì `NavHost` chốt `startDestination` ở lần compose đầu); và giữ chỉ số slide trong field ViewModel thường thì **sống qua xoay, chết khi đổi ngôn ngữ**. Còn lại: screen-reader pass (cần người) + PR. |
