...
> v1.0: Android Native Browser — ✅ Specs 001–016 done (013, 014, 015, 016 đều đã merge vào `main`; 016 qua PR #18, merge commit `3083941`, 2026-09-12). **Phase 3 3/3 · Phase 4 1/3 merged + 017 đã implement** (Spec 016 ở 112/113 — còn TalkBack pass của T109, cần người thật). 🟢 **017 `splash-screen` implemented 2026-09-15 — 35/35 tasks, [PR #20](https://github.com/Xbisme/ThirtySixBrowser/pull/20) đang mở.** **Tiếp theo: 018 `onboarding-flow`.**
