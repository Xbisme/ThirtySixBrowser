...
| 017 | `splash-screen` | 002 | 🟢 Implemented (34/35) |
| 018 | `onboarding-flow` | 003, 004, 006, 017 | ⬜ Next |
| 019 | `tracker-blocker-hostlist` | 011–018 | ⬜ Optional |

> Cập nhật 2026-09-15: Specs 001–016 đã merge vào `main` (016 qua PR #18, 2026-09-12). 🟢 Spec 017 `splash-screen` đã implement (34/35, branch `017-splash-screen`) — G1–G10 đều PASS trên máy ảo, chỉ còn TalkBack cần người thật; bước tiếp theo là mở PR cho 017, rồi thảo luận Spec 018 (`onboarding-flow`). Tiến độ chi tiết xem `sdd-roadmap.md` — bảng này chỉ là tóm tắt.
