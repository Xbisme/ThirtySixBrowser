...
// Package destination: com.raumanian.thirtysix.browser.di
//
// Hilt module providing the DataStore<Preferences> singleton AND binding
// SettingsRepository → SettingsRepositoryImpl. Sits at top-level app/.../di/
// alongside Spec 005's DatabaseModule.
...
/**
 * Provides the application-scoped DataStore<Preferences> singleton.
 *
 * - Single Singleton REQUIRED by DataStore: creating two instances over the
 *   same file from the same process throws IllegalStateException.
...
/**
 * Binds the SettingsRepository interface to its implementation.
 * Two modules in one file is idiomatic Hilt when grouping by feature surface.
 */
@Module
@InstallIn(SingletonComponent::class)
