// Contract — `app/src/main/kotlin/com/raumanian/thirtysix/browser/data/local/dao/BookmarkFolderDao.kt`
...
interface BookmarkFolderDao {
    ...
    /**
     * Direct children of a given folder, ordered by name ascending (Unicode/locale-aware ordering left to higher layers).
     * Pass NULL to retrieve root-level folders.
     */
    @Query(
        """
