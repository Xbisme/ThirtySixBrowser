// Spec 016 contract — platform seam for the app language (FR-013 – FR-017, FR-042).
//
// Interface target:       app/src/main/kotlin/com/raumanian/thirtysix/browser/domain/repository/AppLanguageController.kt
// Implementation target:  app/src/main/kotlin/com/raumanian/thirtysix/browser/data/local/locale/AppCompatAppLanguageController.kt
//                         (@Singleton; bound with @Binds in a module under di/)
//
// Kept in domain/repository/ beside CookieJarSnapshotManager — the same placement Spec 012 chose
...
/**
 * Reads and writes the app language held by the platform's per-app language setting, which is
 * the single source of truth (FR-016, FR-017). The app keeps no copy of its own.
 *
