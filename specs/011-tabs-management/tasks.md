...
- [x] T041 [US2] Run `./gradlew connectedDebugAndroidTest --tests "*TabPersistenceProcessDeathTest*"` — must pass on the CI emulator. If it fails, the persistence path is broken and either Phase 2 or T034 needs revision.
