...
/**
 * Spec 015 T074 (US3 / FR-042 – FR-046).
 *
 * Bookmarks and History lost their bottom-bar buttons to this menu, so these assertions are
 * the regression net for two already-shipped features as much as they are coverage for a
 * new one.
 */
...
class BrowserOverflowMenuTest {
    ...
    @Test
    fun openMenu_listsExactlyTheThreeCollections() {
        render()
